...
export function TenantListPage(props: TenantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTenants({
        relations: ['user', 'guest.count', 'property.count'],
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.rent_due_date ? format(parseISO(record?.rent_due_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'lease_start_date',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.lease_start_date ? format(parseISO(record?.lease_start_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'lease_end_date',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.lease_end_date ? format(parseISO(record?.lease_end_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'rent_amount', header: 'rent_amount', accessorKey: 'rent_amount' },
