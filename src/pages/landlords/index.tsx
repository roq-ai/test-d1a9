...
type ColumnType = ColumnDef<LandlordInterface, unknown>;

interface LandlordListPageProps {
...
export function LandlordListPage(props: LandlordListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<LandlordInterface>>(
    () => `/landlords?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/landlords/view/${record.id}`} passHref legacyBehavior>
                <Button
