  ...
  const fetcher = useCallback(
    async () =>
      getProperties({
        ...
        order: params.order,
        searchTermKeys: ['name.contains', 'address.contains', 'property_type.contains'],
        ...(params.filters || {}),
      }),
    ...
    hasAccess('landlord', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/landlords/view/${record.landlord?.id}`}>
